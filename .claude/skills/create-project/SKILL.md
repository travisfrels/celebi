...
Create project within a local project file (projects) around $ARGUMENTS.
...
4. Create the project file at `projects/V{VERSION}-{INITIATIVE}.md` using the template in `projects/TEMPLATE.md`.
